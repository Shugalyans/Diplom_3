...
class BasePageLocators:
    ...
    MAIN_LAYOUT = (By.XPATH, "//*[contains(@class, 'Modal_modal__loading')]/following::div[@class='Modal_modal_overlay__x2ZCr']") #фон который перекрывает всю страницу и мешает прожать кнопки в Firefox
