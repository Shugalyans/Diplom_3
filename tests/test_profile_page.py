...
class TestProfilePage:
    ...
    def test_click_on_profile_button(self, driver):
        ...
        profile_page.set_current_url(f'{MAIN_PAGE_URL}')
        ...
        assert profile_page.get_current_url() == f'{MAIN_PAGE_URL}login'
    ...
    def test_click_on_orders_history_button(self, driver, make_new_user):
        ...
        assert profile_page.get_current_url() == f'{MAIN_PAGE_URL}account/order-history'
