import allure
from data import MAIN_PAGE_URL, payload, FORGOT_PASSWORD_PAGE_URL, RESET_PASSWORD_PAGE_URL
...
class TestLoginPage:
    ...
    def test_get_return_password_page_by_click_on_button(self, driver):
        ...
        login_page.set_current_url(MAIN_PAGE_URL)
    ...
    def test_enter_email_and_press_recovery_button(self, driver):
        ...
        assert login_page.get_current_url() == RESET_PASSWORD_PAGE_URL
